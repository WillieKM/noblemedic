export function medicalBusinessSchema() {
  return {
    ...
    alternateName: "Noble Medic Wheels Non-Emergency Ambulance Transport",
    ...
    description:
      "ADA-compliant non-emergency ambulance and medical transportation serving King and Pierce County. Wheelchair-accessible rides for dialysis, doctor visits, hospital discharges, and more.",
    priceRange: "$$",
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: { "@type": "Service", name: "Non-Emergency Ambulance Transportation" },
        },
        {
          "@type": "Offer",
